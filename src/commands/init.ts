...
import { FilerConfig, FILER_VERSION } from '../schema/mod.js';
...
export async function initCommand(options: InitOptions): Promise<void> {
  ...
  const modelDefaults: Record<string, { model: string; indexing: string; deep: string }> = {
    anthropic: {
...
function detectIncludePaths(root: string): string[] {
...
function installGitHook(root: string): boolean {
